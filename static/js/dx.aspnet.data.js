...
(function(factory) {
  ...
  function createStoreConfig(options) {
    ...
    function send(operation, requiresKey, ajaxSettings, customSuccessHandler) {
      ...
      if (requiresKey && !keyExpr) {
        d.reject(
          new Error(
            "Primary key is not specified (operation: '" +
              operation +
              "', url: '" +
              ajaxSettings.url +
              "')"
        ...
        if (onBeforeSend) onBeforeSend(operation, ajaxSettings);
    ...
    function loadOptionsToActionParams(options, isCountQuery) {
      ...
      if (options) {
        ['skip', 'take', 'requireTotalCount', 'requireGroupCount'].forEach(
          function(i) {
  ...
  function expandLoadResponse(value) {
    ...
    if (typeof value === 'number') return { totalCount: value };
